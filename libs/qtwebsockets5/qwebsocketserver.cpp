...
#ifndef QT_NO_SSL
                  (secureMode == SecureMode) ? QWebSocketServerPrivate::SecureMode : QWebSocketServerPrivate::NonSecureMode,
#else
...
#ifndef QT_NO_SSL
    Q_D(const QWebSocketServer);
    return (d->secureMode() == QWebSocketServerPrivate::SecureMode) ? QWebSocketServer::SecureMode : QWebSocketServer::NonSecureMode;
#else
